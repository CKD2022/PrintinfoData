...
<script>
    (function() {
        ...
        function initCaptcha() {
            ...
            const bgUrl = 'https://picsum.photos/300/180?random=' + timestamp;
            puzzleArea.style.backgroundImage = 'url(' + bgUrl + ')';
            puzzlePiece.style.backgroundImage = 'url(' + bgUrl + ')';

            const areaWidth = puzzleArea.offsetWidth || 300;
            const areaHeight = puzzleArea.offsetHeight || 180;
            ...
            puzzlePiece.style.backgroundSize = '300px 180px';
        }
        ...
        function endDrag() {
            ...
            if (diff <= CONFIG.tolerance) {
                ...
                setTimeout(function() {
                    ...
                    // 保存验证状态到 sessionStorage，刷新页面后不需要重新验证
